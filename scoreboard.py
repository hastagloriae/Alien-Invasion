...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        """Ініціалізація атрибутів, повязани із рахунком."""
    ...
    def show_score(self):
        """Намалювати рахунок та рівень на екрані"""
    ...
    def check_high_score(self):
        """Перевірити чи встановленно новий рекорд"""
    ...
    def prep_level(self):
        ...
        # Розташуватим рівень під рахунко
